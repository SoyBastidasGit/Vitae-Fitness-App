...
// Función para actualizar la información de perfil de un usuario
  static Future<Map<String, dynamic>> updateProfileInfo(
    ...
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        // Intentamos decodificar el error en JSON, si es posible
        try {
          return json.decode(response.body) as Map<String, dynamic>;
        } catch (e) {
          // Si no es un JSON válido, devolvemos un error genérico
          return {'error': 'Error inesperado: ${response.body}'};
        }
      }
    } catch (e) {
